/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4964fe3b7b4c09ecc6140843b7a20c74)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	QUESTION_IMAGES: KVNamespace;
	DB: D1Database;
	QUESTION_VECTORS: VectorizeIndex;
	AI: Ai;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EDITORIAL_TOKEN">> {}
}
